...
class Startwithai extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Custombutton(text: "Generate my visualization", ontap: (){},gradient:LinearGradient(colors: [Color(0xFF4A6CF7), Color(0xFFC159E1)]),),
              const SizedBox(height: 20),
